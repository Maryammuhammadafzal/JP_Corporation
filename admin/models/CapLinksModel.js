...
const CapLinksSchema = new mongoose.Schema({
  ...
  productFeatureImageRef: { type: String},
  productImageRef: { type: String},
  bLFileRef: { type: String},
  certificateFileRef: { type: String},
  englishCertificateFileRef: { type: String},
  invoiceFileRef: { type: String},
