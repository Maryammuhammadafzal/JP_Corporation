            ...
            <div className="w-full h-auto flex flex-col p-3 justify-center space-y-3 items-start">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCapLink({
                    ...capLink,
                    misc: { ...capLink.misc, descriptionRef: e.target.value },
                  })
                }
                ...
                <div className="flex flex-col w-full gap-2 h-auto">
                  ...
                  >
                    ...
                    <input
                      type="text"
                      id="PartOfDischarge"
                      value={capLink?.arrival?.arrivalPartOfDischargeRef || ""}
                      onChange={(e) =>
                        setCapLink({
                          ...capLink,
                          arrival: {
                ...
                <div className="flex flex-col w-full gap-2 h-auto">
                  ...
                  >
                    ...
                    <input
                      ...
                      value={capLink?.document?.documentPhoneNumber1Ref || ""}
                      onChange={(e) =>
                        setCapLink({
                          ...capLink,
                          document: {
                ...
                <div className="flex flex-col w-full gap-2 h-auto">
                  ...
                  >
                    ...
                    <input
                      ...
                      value={capLink?.document?.documentPhoneNumber2Ref || ""}
                      onChange={(e) =>
                        setCapLink({
                          ...capLink,
                          document: {
                ...
                <div className="flex flex-col w-full gap-2 h-auto">
                  ...
                  >
                    ...
                    <input
                      ...
                      value={capLink?.document?.documentPhoneNumber3Ref || ""}
                      onChange={(e) =>
                        setCapLink({
                          ...capLink,
                          document: {
                ...
                <div className="flex flex-col w-full gap-2 h-auto">
                  ...
                  >
                    ...
                    <input
                      ...
                      value={capLink?.document?.documentFaxNumberRef || ""}
                      onChange={(e) =>
                        setCapLink({
                          ...capLink,
                          document: {
                ...
                <div className="flex flex-col w-full gap-2 h-auto">
                  ...
                  >
                    ...
                    <input
                      ...
                      value={
                        capLink?.document?.documentCellPhoneNumberOREmailRef ||
                        ""
                      }
                      onChange={(e) =>
                        setCapLink({
                          ...
                          document: {
                            ...capLink.document,
                            documentCellPhoneNumberOREmailRef: e.target.value,
                          },
                        })
                      }
                      className=" border-neutral-500 border w-full rounded-md p-3"
                ...
                <div className="w-full">
                  <label htmlFor="documentTrackingNumber" className="w-full">
                    ...
                    <input
                      ...
                      value={capLink?.document?.documentTrackingNumberRef || ""}
                      onChange={(e) =>
                        setCapLink({
                          ...capLink,
                          document: {
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={capLink?.documentCenter?.documentCenterNameRef}
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={
                          capLink?.documentCenter?.documentCenterAddressRef
                        }
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={capLink?.documentCenter?.documentCenterCityRef}
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={
                          capLink?.documentCenter?.documentCenterCountryRef
                        }
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={
                          capLink?.documentCenter?.documentCenterPhoneNumber1Ref
                        }
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                              ...capLink.documentCenter,
                              documentCenterPhoneNumber1Ref: e.target.value,
                            },
                          })
                        }
                        className=" border-neutral-500 border w-full rounded-md p-3"
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={
                          capLink?.documentCenter?.documentCenterPhoneNumber2Ref
                        }
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                              ...capLink.documentCenter,
                              documentCenterPhoneNumber2Ref: e.target.value,
                            },
                          })
                        }
                        className=" border-neutral-500 border w-full rounded-md p-3"
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={
                          capLink?.documentCenter?.documentCenterPhoneNumber3Ref
                        }
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                              ...capLink.documentCenter,
                              documentCenterPhoneNumber3Ref: e.target.value,
                            },
                          })
                        }
                        className=" border-neutral-500 border w-full rounded-md p-3"
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={capLink?.documentCenter?.documentCenterEmailRef}
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                  ...
                  <div className="flex flex-col w-full gap-2 h-auto">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={capLink?.documentCenter?.documentCenterUrlRef}
                        onChange={(e) =>
                          setCapLink({
                            ...capLink,
                            documentCenter: {
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setCapLink({
                            ...
                            documentCenter: {
                              ...capLink.documentCenter,
                              documentCenterOtherInformationRef: e.target.value,
                            },
                          })
                        }
                        className=" border-neutral-500 border w-full rounded-md p-3"
          ...
          <div className="p-6 border-neutral-500 border rounded-md text-sm text-gray-600 w-full h-auto">
            <div className="w-full flex flex-col gap-5 p-3 h-auto items-start">
              <EditInputFeild
                ...
                value={capLink?.notifyParty?.notifyPartyProductNameRef || ""}
                onChange={(e) =>
                  handleChange("notifyPartyProductNameRef", e.target.value)
                }
              ...
              <div className="w-full flex gap-5">
                <EditInputFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartyReferenceNoRef || ""}
                  onChange={(e) =>
                    handleChange("notifyPartyReferenceNoRef", e.target.value)
                  }
                ...
                <EditInputFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartyMileageRef || ""}
                  onChange={(e) =>
              ...
              <div className="w-full flex gap-5">
                <EditInputFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartyModelCodeRef || ""}
                  onChange={(e) =>
                    handleChange("notifyPartyModelCodeRef", e.target.value)
                  }
              ...
              <div className="w-full flex gap-5">
                <EditInputFeild
                  ...
                  type="number"
                  value={capLink?.notifyParty?.manufactureYearORMonthRef || ""}
                  onChange={(e) =>
                    handleChange("manufactureYearORMonthRef", e.target.value)
                  }
                ...
                <EditInputFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartyModelGradeRef || ""}
                  onChange={(e) =>
                    handleChange("notifyPartyModelGradeRef", e.target.value)
                  }
              ...
              <div className="w-full flex gap-5">
                <EditInputFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartyChassisRef || ""}
                  onChange={(e) =>
                ...
                <EditInputFeild
                  ...
                  type="number"
                  value={capLink?.notifyParty?.notifyPartyEngineSizeRef || ""}
                  onChange={(e) =>
                    handleChange("notifyPartyEngineSizeRef", e.target.value)
                  }
              ...
              <div className="w-full flex gap-5">
                <EditSelectFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartySteeringRef || ""}
                  onChange={(e) =>
                ...
                <EditSelectFeild
                  ...
                  value={capLink?.notifyParty?.notifyPartytransmissionRef || ""}
                  onChange={(e) =>
                    handleChange("notifyPartyTransmissionRef", e.target.value)
                  }
                  options={[
                    { value: "AT", label: "AT" },
                        ...
                        >
                          <input
                            ...
                            checked={
                              ...
                              selectedOptionFeatures.includes(feature.value)
                            }
                            onChange={(e) =>
              ...
              <div className="w-full flex flex-col gap-5">
                <div className="imageInput w-full h-auto text-sm rounded-md border p-10">
                  ...
                  {capLink?.productFeatureImageRef && (
                    <div className="w-[200px] mt-5 h-[200px] flex justify-center items-center relative">
                      <div className="text-xl p-1 shadow-lg rounded-full bg-white hover:bg-red-400 cursor-pointer absolute top-0 right-0 z-10">
                        ❌
                      </div>
                      <img
                        loading="lazy"
                ...
                <div className="imageInput w-full h-auto text-sm rounded-md">
                  <div className="flex flex-col gap-2">
                    ...
                    <label htmlFor="productImageRef" className="w-full flex">
                      {/* Custom Button */}
                      <button
                        type="button"
                        className="bg-neutral-300 border border-neutral-500 border-r-0 hover:bg-neutral-400 w-[120px] p-3 rounded-bl-xl rounded-tl-xl shadow-md transition duration-300"
                  ...
                  {capLink?.productImageRef?.length > 0 && (
                    <div className="flex w-auto h-auto p-3">
                      ...
                      >
                        {capLink.productImageRef.map((productImage, index) => (
                          <div
                            key={index}
